...
class School(Building):
    ...
    #         if route_so_far > Time.get_time_from_dattime(8, 30):
    #             raise Exception(
    #                 f"school bus driver arriving at the work zone too late ({Time.i_to_time(route_so_far)})")
    #         _r = [Target(self, Time.get_time_from_dattime(14, 15), None)]
