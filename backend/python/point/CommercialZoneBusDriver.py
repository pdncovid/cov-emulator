...
class CommercialZoneBusDriver(Transporter):
    ...
    def get_random_route(self, t, end_at):
        route_so_far = super(CommercialZoneBusDriver, self).get_random_route(t, Time.get_random_time_between(t, 5, 0, 9,
                                                                                                             0))
        ...
        route_so_far[-1].set_leaving_time(Time.get_random_time_between(t, 16, 30, 18, 30))
